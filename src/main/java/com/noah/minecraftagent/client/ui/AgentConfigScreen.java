...
public final class AgentConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (FieldBinding field : fields) {
            context.drawTextWithShadow(textRenderer, Text.translatable(field.labelKey), field.widget.getX() - 166, field.widget.getY() + 5, 0xFFEDEDED);
        }
        super.render(context, mouseX, mouseY, delta);
        int footerX = x + panelWidth;
        context.drawTextWithShadow(textRenderer, Text.literal("v" + MOD_VERSION), footerX - textRenderer.getWidth("v" + MOD_VERSION), bottom - 30, 0xFF909090);
        context.drawTextWithShadow(textRenderer, Text.literal("github.com/noah0932"), footerX - textRenderer.getWidth("github.com/noah0932"), bottom - 20, 0xFF909090);
        context.drawTextWithShadow(textRenderer, Text.literal("MCAI.noah0932.top"), footerX - textRenderer.getWidth("MCAI.noah0932.top"), bottom - 10, 0xFF909090);
    }
